...
const Footer = () => {
    return (
        <div className='bg-gradient-to-r from-[#121217] to-[#181624] p-10 flex flex-col gap-10 justify-center items-center'>
            <img src="gta_logo_purple.webp" alt="logo" className='h-40' />
            <h3
                className="w-full text-center uppercase font-bold leading-[86%] text-4xl md:text-8xl tracking-[-0.04em] md:tracking-[-0.0125em] antialiased mt-10 mb-20"
                style={{
                    backgroundImage: 'radial-gradient(circle at 50% -30vh, #9d2f6a 0, #fc5243 50vh, #ffd687 90vh, rgba(32, 31, 66, 0) 150vh)',
                    backgroundClip: 'text',
            ...
            <footer className=" text-white p-6">
                <div className="max-w-6xl mx-auto">
                    <div className="mb-6">
                        <p className="text-2xl mb-6 text-center font-semibold">Available on:</p>
                        <div className="flex items-center gap-6 justify-center">
                            ...
                            <span className="sr-only">Xbox Series X|S</span>
                        </div>
                    </div>
                    ...
                    <div className="my-6">
                        <button
                            type="button"
                            className=" text-white px-12 py-4 flex items-center my-8 border-2 border-gray-600 hover:border-gray-500 rounded-4xl gap-6 w-full max-w-3xl"
                        >
                            <div className="flex items-center">
                                <svg
                                    ...
                                    fill="currentColor"
                                    viewBox="0 0 24 24"
                                    className="h-8 w-8 mr-6 flex-shrink-0"
                                    aria-hidden="true"
                                >
                                    <path
                                        fillRule="evenodd"
                                ...
                                <div className="font-bold text-lg">Get Rockstar Propaganda</div>
                            </div>
                            <span className="text-sm text-gray-300 text-left max-w-md">
                    ...
                    <nav className="flex flex-wrap gap-4 text-sm mb-6 font-semibold" role="navigation" aria-label="Footer links">
                        <a href="/corpinfo" className="text-gray-300 hover:text-white hover:underline transition-colors">
                            Corporate
                        </a>
                        <a href="/privacy" className="text-gray-300 hover:text-white hover:underline transition-colors">
                            Privacy
                        </a>
                        <button
                            type="button"
                            className="text-gray-300 hover:text-white hover:underline transition-colors bg-transparent border-none cursor-pointer"
                        >
                            Cookie Settings
                        </button>
                        <a href="/cookies" className="text-gray-300 hover:text-white hover:underline transition-colors">
                            Cookie Policy
                        </a>
                        <a href="/legal" className="text-gray-300 hover:text-white hover:underline transition-colors">
                            Legal
                        </a>
                        <a href="/ccpa" className="text-gray-300 hover:text-white hover:underline transition-colors">
                    ...
                    <div className="flex items-center gap-4 justify-center">
                        <div className="flex-shrink-0">
                            <img src="https://www.rockstargames.com/VI/_next/static/media/esrb.eb620d3e.svg" alt="" />
                        </div>
